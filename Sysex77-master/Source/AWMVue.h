...
public:
    AWMVue()
    {
        ...
        btAfmSource.setButtonText("AFM as source");
        addAndMakeVisible(btAfmSource);
        btAfmSource.onClick = [this]() {
            wavesTable.setEnabled(!btAfmSource.getToggleState());
        };
    ...
    void resized() override
    {
        ...
        btAfmSource.setBounds(btFixed.getX(), btFixed.getBottom() + 15, 140, 24);
